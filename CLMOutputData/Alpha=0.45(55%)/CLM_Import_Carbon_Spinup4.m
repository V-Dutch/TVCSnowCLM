...
%% Import CLM Output
cd 'D:\PhD Work\Modelling\CLM\Output Data From CLM\Paper 1\GitRepo\SensitivityTests_SpinUp\Alpha=0.45(55%)' % folder for model run, needs changing every time
%% Import Snow Parameters
% Hourly Snow Parameters:
SnowDepth_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h0.2013-01-01-00000.nc','SNOWDP');
Snowfall_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h0.2013-01-01-00000.nc','SNOW');
SWE_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h0.2013-01-01-00000.nc','H2OSNO'); 
SnowCoverFraction_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h0.2013-01-01-00000.nc','FSNO');
...
SnowLayerPresence = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h4.2013-01-01-00000.nc', 'SNO_EXISTENCE'); 
% 1 = Layer Present, 0 = Layer absent, decimal = proportion of hourly timestep layer present for 
SnowLayerDensities = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h4.2013-01-01-00000.nc','SNO_RHO'); %Only in runs 4 and onward
SnowLayerGrainRadii = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h4.2013-01-01-00000.nc','SNO_GS'); %Only in runs 6 and onward
SnowThermalConductivities = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h4.2013-01-01-00000.nc','SNO_TK');
SnowLayerThickness = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h4.2013-01-01-00000.nc','SNO_Z');
SnowLayerTemps = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h4.2013-01-01-00000.nc','SNO_T');
SnowLayerTemps = SnowLayerTemps - 273.15; % convert units
SnowIceContent = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h4.2013-01-01-00000.nc','SNO_ICE'); % hoping this will help explain density/Keff relationship
SnowLiquidWater = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h4.2013-01-01-00000.nc','SNO_LIQH2O'); % hoping this will help explain density/Keff relationship
...
SoilTemp_10cm_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h1.2013-01-01-00000.nc','TSOI_10CM');
...
SoilLayerTemps_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h1.2013-01-01-00000.nc','TSOI');
...
SoilLayerPotentialWater_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h1.2013-01-01-00000.nc','SOILPSI');
...
SoilTemp_155cm_CLM = SoilLayerTemps_CLM(11,:);
...
SoilTemp_155cm_CLM = rot90(SoilTemp_155cm_CLM,3);
...
CO2Flux_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h2.2013-01-01-00000.nc','FCO2'); % Includes fires etc not in NEE
CH4Flux_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h2.2013-01-01-00000.nc','FCH4');

NEE_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h2.2013-01-01-00000.nc','NEE'); % NEE = NPP - ER
NPP_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h2.2013-01-01-00000.nc','NPP');
ER_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h2.2013-01-01-00000.nc','ER');
SoilResp_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h1.2013-01-01-00000.nc','SR'); 
...
AirTemp_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h3.2013-01-01-00000.nc','TBOT');
AirTemp_CLM = AirTemp_CLM - 273.15; % convert units
Rainfall_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h3.2013-01-01-00000.nc','RAIN');
RelativeHumidity_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h3.2013-01-01-00000.nc','RH');
Shortwave_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h3.2013-01-01-00000.nc','FLDS');
Longwave_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h3.2013-01-01-00000.nc','FSDS');
Pressure_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h3.2013-01-01-00000.nc','PBOT');
Pressure_CLM = Pressure_CLM/1000; % convert to KPa to match Obs
Windspeed_CLM = ncread('Ptclm_TVC_lw0512_SnowRHO_Bulk55_Spinup4.clm2.h3.2013-01-01-00000.nc','WIND');
...
%% Construct Timetable
% Hourly Parameters:
STest55_S4_Hourly = timetable(RawObs_Hourly.TIMESTAMP,RawObs_Hourly{:,6},AirTemp_CLM,RawObs_Hourly{:,7},RelativeHumidity_CLM,...
    ...
    SoilTemp_40cm_CLM,SoilTemp_80cm_CLM,SoilTemp_136cm_CLM,SoilTemp_155cm_CLM,SoilTemp_208cm_CLM,SoilTemp_250cm_CLM,SoilTemp_299cm_CLM,SoilTemp_358cm_CLM,SoilTemp_427cm_CLM,...% "Deep" CLM Soil temps
...
% rename columns
STest55_S4_Hourly.Properties.VariableNames{1} = 'AirTemp_Obs';
STest55_S4_Hourly.Properties.VariableNames{2} = 'AirTemp_CLM';
STest55_S4_Hourly.Properties.VariableNames{3} = 'RH_Obs';
STest55_S4_Hourly.Properties.VariableNames{4} = 'RH_CLM';
STest55_S4_Hourly.Properties.VariableNames{5} = 'Shortwave_Obs';
STest55_S4_Hourly.Properties.VariableNames{6} = 'Shortwave_CLM';
STest55_S4_Hourly.Properties.VariableNames{7} = 'Longwave_Obs';
STest55_S4_Hourly.Properties.VariableNames{8} = 'Longwave_CLM';
STest55_S4_Hourly.Properties.VariableNames{9} = 'AirPressure_Obs';
STest55_S4_Hourly.Properties.VariableNames{10} = 'AirPressure_CLM';
STest55_S4_Hourly.Properties.VariableNames{11} = 'Rainfall_Obs';
STest55_S4_Hourly.Properties.VariableNames{12} = 'Rainfall_CLM';
STest55_S4_Hourly.Properties.VariableNames{13} = 'Snowfall_Obs';
STest55_S4_Hourly.Properties.VariableNames{14} = 'Snowfall_CLM';
STest55_S4_Hourly.Properties.VariableNames{15} = 'SnowDepth_Echosounder_obs';
STest55_S4_Hourly.Properties.VariableNames{16} = 'SnowDepth_MSC_obs';
STest55_S4_Hourly.Properties.VariableNames{17} = 'SnowDepth_CLM';
STest55_S4_Hourly.Properties.VariableNames{18} = 'SWE_CLM';
STest55_S4_Hourly.Properties.VariableNames{19} = 'SCF_CLM';
% Want to splice in layer properties at this point
STest55_S4_Hourly.Properties.VariableNames{20} = 'SoilTemp_2cm_Obs';
STest55_S4_Hourly.Properties.VariableNames{21} = 'SoilTemp_5cm_Obs';
STest55_S4_Hourly.Properties.VariableNames{22} = 'SoilTemp_10cm_Obs';
STest55_S4_Hourly.Properties.VariableNames{23} = 'SoilTemp_20cm_Obs';
STest55_S4_Hourly.Properties.VariableNames{24} = 'SoilTemp_1cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{25} = 'SoilTemp_4cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{26} = 'SoilTemp_9cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{27} = 'SoilTemp_10cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{28} = 'SoilTemp_16cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{29} = 'SoilTemp_26cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{30} = 'SoilTemp_40cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{31} = 'SoilTemp_80cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{32} = 'SoilTemp_136cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{33} = 'SoilTemp_155cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{34} = 'SoilTemp_208cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{35} = 'SoilTemp_250cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{36} = 'SoilTemp_299cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{37} = 'SoilTemp_358cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{38} = 'SoilTemp_427cm_CLM';

STest55_S4_Hourly.Properties.VariableNames{39} = 'PotentialSoilWater_1cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{40} = 'SoilMoisture_2cm_Obs';
STest55_S4_Hourly.Properties.VariableNames{41} = 'PotentialSoilWater_4cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{42} = 'SoilMoisture_5cm_Obs';
STest55_S4_Hourly.Properties.VariableNames{43} = 'PotentialSoilWater_9cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{44} = 'SoilMoisture_10cm_Obs'; 
STest55_S4_Hourly.Properties.VariableNames{45} = 'PotentialSoilWater_16cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{46} = 'SoilMoisture_20cm_Obs';
STest55_S4_Hourly.Properties.VariableNames{47} = 'PotentialSoilWater_26cm_CLM';
STest55_S4_Hourly.Properties.VariableNames{48} = 'NEE_Obs';
STest55_S4_Hourly.Properties.VariableNames{49} = 'NEE_CLM';
STest55_S4_Hourly.Properties.VariableNames{50} = 'CH4_Obs';
STest55_S4_Hourly.Properties.VariableNames{51} = 'CH4_CLM';
STest55_S4_Hourly.Properties.VariableNames{52} = 'NPP_CLM';
STest55_S4_Hourly.Properties.VariableNames{53} = 'EcosysResp_CLM';
STest55_S4_Hourly.Properties.VariableNames{54} = 'CO2Flux_CLM'; 
STest55_S4_Hourly.Properties.VariableNames{55} = 'SoilResp_CLM';

% export
cd 'D:\PhD Work\Modelling\CLM\Output Data From CLM\Paper 1\GitRepo\SensitivityTests_SpinUp\Alpha=0.45(55%)'
writetimetable(STest55_S4_Hourly,'STest55_S4_Hourly.csv');

% Daily Parameters:
STest55_S4_Daily = retime(STest55_S4_Hourly,'Daily');
STest55_S4_Daily(end,:) = []; % creates empty row for first of Jan, remove it

STest55_S4_Daily = addvars(STest55_S4_Daily,SnowLayerGrainRadii,'Before','SoilTemp_1cm_CLM');
STest55_S4_Daily = addvars(STest55_S4_Daily,SnowLayerDensities,'Before','SnowLayerGrainRadii');
STest55_S4_Daily = addvars(STest55_S4_Daily,SnowLayerThickness,'Before','SnowLayerDensities');
STest55_S4_Daily = addvars(STest55_S4_Daily,SnowThermalConductivities,'Before','SoilTemp_1cm_CLM');
STest55_S4_Daily = addvars(STest55_S4_Daily,SnowLayerTemps,'Before','SoilTemp_1cm_CLM');
STest55_S4_Daily = addvars(STest55_S4_Daily,SnowIceContent, 'Before','SoilTemp_1cm_CLM');
STest55_S4_Daily = addvars(STest55_S4_Daily,SnowLiquidWater,'Before','SoilTemp_1cm_CLM');

%export
writetimetable(STest55_S4_Daily,'STest55_S4_Daily.csv');